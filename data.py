def get_info():
    ...
    Introduction 5
    1.1 Themes and Concepts of Biology 5
    1.2 The Process of Science 16
    Key Terms 24
    Chapter Summary 24
    ...
    Introduction 133
    6.1 The Genome 133
    6.2 The Cell Cycle 135
    6.3 Cancer and the Cell Cycle 141
    6.4 Prokaryotic Cell Division 142
    Key Terms 146
    Chapter Summary 147
    ...
    Chapter Summary 167
    Access for free at openstax.org
    Visual Connection Questions 168
    ...
    Introduction 197
    9.1 The Structure of DNA 198
    9.2 DNA Replication 202
    9.3 Transcription 209
    9.4 Translation 212
    9.5 How Genes Are Regulated 215
    Key Terms 219
    Chapter Summary 220
    ...
    Introduction 247
    11.1 Discovering How Populations Change 248
    11.2 Mechanisms of Evolution 254
    11.3 Evidence of Evolution 256
    11.4 Speciation 259
    11.5 Common Misconceptions about Evolution 264
    Key Terms 268
    Chapter Summary 268
    ...
    Chapter Summary 348
    Access for free at openstax.org
    Visual Connection Questions 348
    ...
    Introduction 397
    16.1 Homeostasis and Osmoregulation 398
    16.2 Digestive System 402
    16.3 Circulatory and Respiratory Systems 408
    16.4 Endocrine System 414
    16.5 Musculoskeletal System 420
    16.6 Nervous System 426
    Key Terms 436
    Chapter Summary 438
    ...
    Customization
    Concepts of Biology is licensed under a Creative
    Commons Attribution 4.0 International (CC BY) license,
    which means that you can distribute, remix, and build
    upon the content, as long as you provide attribution to
    ...
    customized version of their OpenStax book. Visit the
    Instructor Resources section of your book page on
    OpenStax.org for more information.
    Art attribution
    In Concepts of Biology, most art contains attribution to
    its creator within the caption. Because the art is openly
    licensed, anyone may reuse the art as long as they
    provide the same attribution to its original source. To
    maximize readability and content flow, some art does
    not include attribution in the text. If you reuse art from
    this text that does not have attribution provided, use
    the following attribution: Copyright Rice University,
    ...
    textbook, errors sometimes occur. In addition, the wide
    range of topics, data, and legal circumstances in
    sociology change frequently, and portions of the
    textbook may become out of date. Since our books are
    ...
    The web view is the recommended format because it is
    the most accessible – including being WCAG 2.0 AA
    compliant – and most current. Print versions are
    available for individual purchase, or they may be
    ordered through your campus bookstore.
    About Concepts of Biology
    Concepts of Biology is designed for the singlesemester
    introduction to biology course for nonscience
    majors, which for many students is their only
    ...
    Biology is grounded on an evolutionary basis and
    ...
    course. A strength of Concepts of Biology is that
    ...
    Preface 1
    Coverage and Scope
    Our Concepts of Biology textbook adheres to the scope
    ...
    • Everyday Connection features tie biological
    ...
    • Visual Connection features call out core figures in
    ...
    2 Preface
    Access for free at openstax.org
    critical thinking and analytical abilities to ensure
    their genuine understanding of the concept at
    hand.
    • Link to Learning features direct students to online
    interactive exercises and animations to add a fuller
    context and examples to core content.
    About Our Team
    Concepts of Biology would not be possible if not for the
    ...
    Learning Resources
    Wiley Plus for Biology-Fall 2013 Pilot WileyPLUS
    ...
    neurobiology. All of SimBio’s modules include instantfeedback
    questions that enhance student
    ...
    Preface 3
    Academic Integrity
    Academic integrity builds trust, understanding, equity,
    ...
    should work together to maintain a fair and positive
    experience.
    We realize that students benefit when academic
    integrity ground rules are established early in the
    course. To that end, OpenStax has created an
    interactive to aid with academic integrity discussions in
    your course.
    Visit our academic integrity slider (https://www.openstax.org/
    r/academic-integrity-slider). Click and drag icons along the
    continuum to align these practices with your institution and
    ...
    accessible, our technology partners offer optional lowcost
    tools that are integrated with OpenStax books. To
    ...
    1.1 • Themes and Concepts of Biology 7
    ...
    contains it.
    1.1 • Themes and Concepts of Biology 9
    ...
    single cell and others are multicellular. Cells are classified as prokaryotic or eukaryotic. Prokaryotes are singlecelled
    organisms that lack organelles surrounded by a membrane and do not have nuclei surrounded by nuclear
    ...
    1.1 • Themes and Concepts of Biology 11
    ...
    1.1 • Themes and Concepts of Biology 15
    ...
    author’s permission.
    1.2 • The Process of Science 23
    Key Terms
    applied science a form of science that solves realworld
    problems
    atom a basic unit of matter that cannot be broken
    down by normal chemical reactions
    basic science science that seeks to expand
    knowledge regardless of the short-term application
    of that knowledge
    biology the study of life
    biosphere a collection of all ecosystems on Earth
    cell the smallest fundamental unit of structure and
    function in living things
    community a set of populations inhabiting a
    particular area
    control a part of an experiment that does not change
    during the experiment
    deductive reasoning a form of logical thinking that
    uses a general statement to predict specific results
    descriptive science a form of science that aims to
    observe, explore, and find things out
    ecosystem all living things in a particular area
    together with the abiotic, nonliving parts of that
    environment
    eukaryote an organism with cells that have nuclei
    and membrane-bound organelles
    evolution the process of gradual change in a
    population that can also lead to new species arising
    from older species
    falsifiable able to be disproven by experimental
    results
    ...
    which can be tested
    hypothesis-based science a form of science that
    ...
    conclusion
    life science a field of science, such as biology, that
    studies living things
    macromolecule a large molecule typically formed by
    the joining of smaller molecules
    molecule a chemical structure consisting of at least
    two atoms held together by a chemical bond
    natural science a field of science that studies the
    physical world, its phenomena, and processes
    organ a structure formed of tissues operating
    together to perform a common function
    organ system the higher level of organization that
    consists of functionally related organs
    organelle a membrane-bound compartment or sac
    within a cell
    organism an individual living entity
    peer-reviewed article a scientific report that is
    reviewed by a scientist’s colleagues before
    publication
    phylogenetic tree a diagram showing the
    evolutionary relationships among biological species
    based on similarities and differences in genetic or
    physical traits or both
    physical science a field of science, such as
    astronomy, physics, and chemistry, that studies
    nonliving matter
    ...
    science knowledge that covers general truths or the
    operation of general laws, especially when acquired
    and tested by the scientific method
    scientific law a description, often in the form of a
    mathematical formula, for the behavior of some
    ...
    observation
    scientific theory a thoroughly tested and confirmed
    explanation for observations or phenomena
    tissue a group of similar cells carrying out the same
    function
    variable a part of an experiment that can vary or
    change
    Chapter Summary
    1.1 Themes and Concepts of Biology
    ...
    turn, are grouped as populations, communities,
    ...
    certain circumstances. Two types of logical reasoning
    ...
    1. Figure 1.8 Which of the following statements is
    false?
    ...
    2. Figure 1.18 In the example below, the scientific
    method is used to solve an everyday problem.
    Which part in the example below is the hypothesis?
    Which is the prediction? Based on the results of the
    experiment, is the hypothesis supported? If it is not
    supported, propose some alternative hypotheses.
    1. My toaster doesn’t toast my bread.
    2. Why doesn’t my toaster work?
    ...
    6. My coffeemaker works.
    Review Questions
    3. The smallest unit of biological structure that meets
    the functional requirements of “living” is the
    ________.
    a. organ
    b. organelle
    c. cell
    d. macromolecule
    4. Which of the following sequences represents the
    ...
    1 • Visual Connection Questions 25
    Critical Thinking Questions
    7. Using examples, explain how biology can be studied
    from a microscopic approach to a global approach.
    8. Give an example of how applied science has had a
    direct effect on your daily life.
    ...
    The time it takes for half of the original concentration of an isotope to decay to its more stable form is called its halflife.
    Because the half-life of 14C is long, it is used to age formerly living objects, such as fossils. Using the ratio of the
    ...
    buffer system involves carbonic acid (H2CO3) and bicarbonate (HCO3
    –) anion. If too much H+ enters the body,
    ...
    Lipids
    Lipids include a diverse group of compounds that are united by a common feature. Lipids are hydrophobic (“waterfearing”),
    or insoluble in water, because they are nonpolar molecules. This is because they are hydrocarbons that
    ...
    rhesus monkey sequences were compared, a single difference was found in one amino acid. In contrast, human-toyeast
    comparisons show a difference in 44 amino acids, suggesting that humans and chimpanzees have a more
    ...
    polynucleotide, DNA or RNA. Each nucleotide is made up of three components: a nitrogenous base, a pentose (fivecarbon)
    sugar, and a phosphate group (Figure 2.22). Each nitrogenous base in a nucleotide is attached to a sugar
    ...
    lipids a class of macromolecules that are nonpolar
    ...
    nucleic acid a biological macromolecule that carries
    ...
    the nucleus of an atom; has a mass of 1 and a
    charge of +1
    ...
    the following statements is true of a neutral
    magnesium atom?
    ...
    15. Explain at least three functions that lipids serve in
